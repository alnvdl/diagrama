...
Editor and Mermaid. You can obtain further information from README.md,
including instructions on running and testing.
...
`document.getElementById` in JavaScript files that are not `src/main.js`.
